    ...
    <body>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <marquee behavior="scroll" class="btn btn-dark">Selamat Datang <b></b> Aplikasi Perpustakaan Sederhana SMK N 2 Banjarmasin</marquee>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; RPL A Kelas XI SMKN 2 Banjarmasin</div>
                            <div>
                                <a href="#">Website SMKN 2 Banjarmasin</a>
                                &middot;
